"""
Polynomial Kernel SVM 训练 - Letter Recognition Dataset
...
# ========== 1. 加载数据 ==========
print("=" * 60)
print("Polynomial Kernel SVM - Letter Recognition")
print("=" * 60)
...
# ========== 4. 训练 Polynomial Kernel SVM ==========
print("\n>>> 开始训练 Polynomial Kernel SVM (degree=3) ...")
...
# ========== 5. 预测 ==========
print("\n>>> 预测中 ...")
y_pred_train = poly_svm.predict(X_train_scaled)
...
model_path = os.path.join(model_dir, "poly_svm_model.pkl")
scaler_path = os.path.join(model_dir, "poly_svm_scaler.pkl")

joblib.dump(poly_svm, model_path)
